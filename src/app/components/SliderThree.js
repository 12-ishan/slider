...
export default function SliderThree() {
  ...
  return (
    <Slider {...settings}>
      <div>
        <div className="faculty-mentors">
          <Image src="/assets/images/shubhashis-gangopadhyay.jpg" alt="" title="" width={300} height={150} />
      ...
      <div>
        <div className="faculty-mentors">
          <Image src="/assets/images/krishna-k-ladha.jpg" alt="" title="" width={300} height={150} />
      ...
      <div>
        <div className="faculty-mentors">
          <Image src="/assets/images/o-p-agarwal.jpg" alt="" title="" width={300} height={150} />
      ...
      <div>
        <div className="faculty-mentors">
          <Image src="/assets/images/archana-gulati.jpg" alt="" title="" width={300} height={150} />
      ...
      <div>
        <div className="faculty-mentors">
          <Image src="/assets/images/nandita-banerjee.jpg" alt="" title="" width={300} height={150} />
      ...
      <div>
        <div className="faculty-mentors">
          <Image src="/assets/images/kanu-priya-sekhri.jpg" alt="" title="" width={300} height={150} />
